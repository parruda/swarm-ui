...
ActiveRecord::Schema[8.0].define(version: 2025_08_04_205015) do
  ...
  create_table "instance_templates", force: :cascade do |t|
    ...
    t.json("tags", default: [])
    t.index(["category"], name: "index_instance_templates_on_category")
  ...
  create_table "swarm_templates", force: :cascade do |t|
    ...
    t.index(["system_template"], name: "index_swarm_templates_on_system_template")
  end
